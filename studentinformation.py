...
def update_student(student_info):
    global update_window, name_entry, sex_var_update, email_entry, address_entry, contact_entry, birthday_entry
    ...
    sex_var_update = tk.StringVar(value=student_info[2])
    ...
    email_entry = tk.Entry(update_window, textvariable=tk.StringVar(value=student_info[3]), width=30)
    ...
    address_entry = tk.Entry(update_window, textvariable=tk.StringVar(value=student_info[4]), width=30)
    ...
    contact_entry = tk.Entry(update_window, textvariable=tk.StringVar(value=student_info[5]), width=30)
    ...
    birthday_entry = DateEntry(update_window, width=12, background='darkblue', foreground='white', borderwidth=2, date_pattern="MM/dd/yyyy", date_var=tk.StringVar(value=student_info[6]))
    birthday_entry.grid(row=7, column=1, padx=10, pady=5, sticky="w")

    tk.Button(update_window, text="Update Student", command=lambda: save_updated_student(student_info[0]), font=("Helvetica", 12)).grid(row=8, column=0, columnspan=2, pady=10, padx=20, sticky="we")
